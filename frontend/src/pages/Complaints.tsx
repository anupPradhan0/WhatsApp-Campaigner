...
export default function Complaints() {
  ...
  return (
    <>
      ...
      {modal === 'view' && selected && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/80" onClick={closeModal}>
          <div onClick={e => e.stopPropagation()} className="w-full max-w-[540px] max-h-[90vh] overflow-y-auto bg-surface border border-brand-border shadow-[0_0_0_1px_rgba(22,163,74,0.08),0_24px_64px_-16px_rgba(0,0,0,0.85)] rounded-2xl">
            <div className="flex items-center justify-between px-5 py-4 border-b border-line">
      ...
      {modal === 'edit' && selected && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/80" onClick={closeModal}>
          <div onClick={e => e.stopPropagation()} className="w-full max-w-[440px] max-h-[90vh] overflow-y-auto bg-surface border border-brand-border shadow-[0_0_0_1px_rgba(22,163,74,0.08),0_24px_64px_-16px_rgba(0,0,0,0.85)] rounded-2xl">
            <div className="flex items-center justify-between px-5 py-4 border-b border-line">
