...
import { Send, Phone, Link2, ImageIcon, Users, X, Hash, Upload, FileSpreadsheet, UserCircle, Save, AlertTriangle, Eye, ArrowLeft, Video, MoreVertical, Mic, Signal, Wifi, BatteryFull, Camera, Smile, Paperclip } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-5">
        ...
        {/* Live WhatsApp preview — phone mockup */}
            ...
            <div style={{ background: '#202c33' }}>
              ...
              <div className="flex items-center gap-2 px-2.5 py-2">
                ...
                <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0 bg-[#0b141a] flex items-center justify-center">
                  {profileUrl ? <img src={profileUrl} alt="" className="w-full h-full object-cover" /> : <UserCircle size={22} className="text-[#8696a0]" />}
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-[13px] font-semibold text-[#e9edef] truncate leading-tight">{formData.campaignName || 'Your Business'}</p>
            ...
            >
              ...
              <div className="max-w-[85%] rounded-lg rounded-tl-none overflow-hidden shadow-[0_1px_1px_rgba(0,0,0,0.35)]" style={{ background: '#202c33' }}>
                ...
                <div className="px-2.5 py-2">
                  ...
                  <div className="text-right text-[10px] mt-1" style={{ color: '#8696a0' }}>9:41 AM</div>
                </div>
