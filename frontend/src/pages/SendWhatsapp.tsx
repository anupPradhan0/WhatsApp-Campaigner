    ...
    <>
      ...
      <div className="flex flex-col gap-5">
        ...
        <aside className="lg:sticky lg:top-4 flex flex-col gap-3 order-first lg:order-none">
          ...
          <WhatsAppPreview
            name={formData.campaignName || 'Your Business'}
            profileImage={profileUrl}
            message={formData.message}
            mediaImage={mediaUrl}
            mediaIsVideo={!!selectedFile && fileType === 'video'}
            phoneButtonText={hasPhoneBtn ? formData.phoneButtonText : null}
            linkButtonText={hasLinkBtn ? formData.linkButtonText : null}
          />
